  ...
  let setInt = setInterval(() => {
    ...
    result.innerHTML = `
        <div class="d-flex justify-content-between px-2 py-3  text-white">
            <div style="width:50px; height:100px;" class="d-flex flex-column bg-primary">
            <span class="d-inline-block h5">${total_day}</span>
            <span class="h5 px-2"> Day </span>
            </div>
           
            :
            <div style="width:50px; height:100px;" class="d-flex flex-column bg-primary px-2 py-3 text-white">
